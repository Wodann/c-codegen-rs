...
impl_froms!(ForDeclaration: Declaration, Expression);
    ...
    AllocatorT::Doc: Clone,
{
    fn pretty(self, allocator: &'a AllocatorT) -> pretty::DocBuilder<'a, AllocatorT, AnnotationT> {
        match self {
            ForDeclaration::Declaration(declaration) => declaration.pretty(allocator),
...
mod tests {
    ...
    use crate::{
        ...
        operator::{BinaryOperator, BinaryOperatorKind, PrefixOperator, PrefixOperatorKind},
            ...
            r#"for (i; 1; i)
{
  x;
        ...
        let init_condition_step = For {
            init: Some(ForDeclaration::Declaration(Declaration {
                storage_class: None,
                ty: Type::Size,
